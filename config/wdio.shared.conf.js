...
exports.config = {
    ...
    // seleniumLogs: './temp/logs/selenium-log.log',
    services: [
        ['selenium-standalone', {
            logPath: './temp',
            args: {
                version: selArgs.version,
                seleniumArgs: ['-host', '127.0.0.1', '-port', '4449'],
                drivers: {
                    chrome: { version: selArgs.drivers.chrome.version },
                    firefox: { version: selArgs.drivers.firefox.version }
                }
            },
        }]
    ],
    ...
    cucumberOpts: {
        require: ['./specs/step-definitions/**/*.ts'],        // <string[]> (file/dir) require files before executing features
